...
class Engine {
   ...
   private readonly pieceValue = [
      ...
      [100, 300, 350, 490, 900, 15000, -100, -300, -350, -490, -900, -15000],
      // endgame scores
      [120, 270, 300, 550, 1050, 15000, -120, -270, -300, -550, -1050, -15000]
   ];
   ...
   private readonly pieceSquareValues = [
      ...
      [
         ...
         [
            -100, -50, -50, -50, -50, -50, -50, -100,
             ...
             -50,   5,  40,  10,  10,  50,   5,  -50,
             -50,   5,  15,  35,  35,  15,   5,  -50,
             -50,   5,  15,  20,  20,  15,   5,  -50,
             -50,   5,  25,   5,   5,  25,   5,  -50,
             -50, -25,   0,  10,  10,   0, -25,  -50,
            -100, -50, -50, -50, -50, -50, -50, -100,
         ],
         ...
         // rook
         [
           30,  20,  20,  20,  20,  20,  20,  25,
           35,  30,  30,  20,  25,  25,  25,  30,
      ...
      [
         ...
         // king
         [
          -60, -35, -30, -30, -30, -30, -35, -60,
          -35,  10,  10,  10,  10,  10,  10, -35,
